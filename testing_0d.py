# Created on Wed Sep 13 22:16:29 2017
# @author: tom
...
def iteration_over_space(path_test_times, path_test_values, C, COV, densities, structure, k,
    ...
    hist_probs, input_coordinates, shape_of_grid =\
        histogram_of_probabilities(path_test_times, C, COV, densities, structure, k,
                                   edge_of_square, timestep)
    print(hist_probs)
    with open('/home/tom/projects/atomousek/stroll_fremen_nd/output/variables/binary_positive.txt', 'w') as file1:
                file1.write(str(list(hist_probs)))
...
#    prvni_kolo = 0
    ...
    while t_max >= 2:
        ...
        diff_n = []
        diff_p = []
        model = np.histogramdd(input_coordinates, bins=t_max,
